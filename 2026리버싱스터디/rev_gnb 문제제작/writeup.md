...
성공적으로 플래그를 띄우셨다니 축하드립니다! 디버거를 이용해 런타임에 값을 조작하여 로직을 비틀어버리는 리버싱의 핵심 재미를 느끼셨을 것 같네요.

공부하신 내용을 복습하고 정리할 수 있도록, 이 문제의 **공식 라이트업(Write-up)**을 작성해 드립니다.

---

## [Write-up] Challenge: The Encrypted Note
